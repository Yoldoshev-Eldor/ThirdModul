...
namespace WebManagment.Server
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IWebManagmentService,WebManagmentService>();
            builder.Services.AddSingleton<IStorageBroker,LocalStorageBrokre>();
